...
<div
    class="[&_.dropdown-trigger]:grid [&_.dropdown-trigger]:size-11 [&_.dropdown-trigger]:cursor-pointer [&_.dropdown-trigger]:place-items-center [&_.dropdown-trigger]:p-0 [&_.dropdown-trigger]:text-white [&_.dropdown-trigger]:transition-[opacity,transform] [&_.dropdown-trigger]:duration-150 [&_.dropdown-trigger]:hover:bg-transparent [&_.dropdown-trigger]:hover:opacity-75 [&_.dropdown-trigger]:focus-visible:outline-1 [&_.dropdown-trigger]:focus-visible:outline-white [&_.dropdown-trigger]:active:scale-90 [&_.dropdown-root:has(.dropdown-menu:popover-open)_.dropdown-trigger]:bg-transparent! sm:[&_.dropdown-trigger]:size-8"
>
    <Dropdown
        id="player-settings"
