...
import { availableAnimeSeasons, currentAnimeSeason, parseAnimeSeason } from '@arc/shared/season';
...
describe('anime seasons', () => {
    test.each([
        ...
        expect(currentAnimeSeason(new Date(Date.UTC(2026, month, 1)))).toEqual({
            season,
            year: 2026,
        });
    });
