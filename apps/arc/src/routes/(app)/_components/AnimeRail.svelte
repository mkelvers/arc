    ...
    {#if anime.length}
        <div class="relative [--rail-control-center:50%]">
            <div
                ...
                class="scrollbar-hidden grid grid-flow-col auto-cols-[calc((100vw-2.75rem)/2)] gap-3 overflow-x-auto overscroll-x-contain px-4 pb-4 scroll-smooth min-[30em]:auto-cols-[calc((100vw-4rem)/3)] min-[35.5em]:auto-cols-[calc((100vw-4.75rem)/4)] sm:auto-cols-[calc((100vw-7.75rem)/4)] sm:gap-4 sm:px-10 lg:auto-cols-[calc((100vw-12rem)/5)] lg:gap-[1.875rem] lg:px-16 2xl:auto-cols-[calc((100vw-14.5rem)/6)] 2xl:px-16 min-[120rem]:auto-cols-[calc((100vw-16rem)/7)]"
            >
