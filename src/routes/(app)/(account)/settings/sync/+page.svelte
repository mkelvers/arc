...
<section class="mt-10" aria-labelledby="what-to-sync">
    ...
    <div class="mt-5 space-y-4">
        <div class="flex items-center justify-between gap-6 text-sm leading-relaxed text-muted">
            ...
            <form method="POST" action="?/update">
                ...
                <input
                    type="hidden"
                    name="enabled"
                    value={String(!data.settings.episodeProgress)}
                />
                <span class="relative flex size-4 items-center justify-center">
                    <input
                        type="checkbox"
        ...
        <div
            class="mt-8 flex items-center justify-between gap-6 text-sm leading-relaxed text-muted"
        >
            ...
            <form method="POST" action="?/update">
                ...
                <input
                    type="hidden"
                    name="enabled"
                    value={String(!data.settings.importAnilistChanges)}
                />
                <span class="relative flex size-4 items-center justify-center">
                    <input
                        type="checkbox"
