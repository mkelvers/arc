  ...
  <div class="mt-16 space-y-6">
    <div>
      <div
        class={cn(
          ...
          username.length > 0 || usernameInvalid ? 'border-accent' : 'border-border-strong'
        )}
      >
        <input
          id="username"
        ...
        <label
          ...
          class={cn(
            ...
            username.length > 0 || usernameInvalid ? 'text-accent' : 'text-foreground'
          )}
        >
          Username
        </label>
    ...
    <div>
      <div
        class={cn(
          'relative h-13 border-b transition-colors focus-within:border-accent',
          password.length > 0 || passwordInvalid ? 'border-accent' : 'border-border-strong'
        )}
      >
        <input
          id="password"
        ...
        <label
          ...
          class={cn(
            'pointer-events-none absolute top-1 left-0 text-xs transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-xs peer-focus:text-accent',
            password.length > 0 || passwordInvalid ? 'text-accent' : 'text-foreground'
          )}
        >
          Password
        </label>
