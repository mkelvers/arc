...
const animeIds = [
  16498, 18397, 21459, 97940, 99263, 101280, 101922, 105310, 105333, 108465, 113415, 11757, 120377,
  125206, 131573, 137822, 146984, 151807, 153288, 154587,
];
  ...
  liveTest(
    ...
    async () => {
      ...
      for (const posters of samples) {
        expect(new Set(posters.map(({ file_path }) => file_path)).size).toBeGreaterThanOrEqual(8);
        expect(
