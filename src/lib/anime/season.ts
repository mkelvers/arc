...
export function compareAnimeSeasons(
    left: AnimeSeasonSelection,
    right: AnimeSeasonSelection,
) {
    return (
        left.year - right.year ||
        animeSeasons.indexOf(left.season) -
            animeSeasons.indexOf(right.season)
    );
}

export function availableAnimeSeasons(
    starts: AnimeSeasonStartYears,
    latest: AnimeSeasonSelection,
) {
