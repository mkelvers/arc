...
`@arc/shared` mixed several unrelated responsibilities. It now contains only the canonical GraphQL source tree. The table below records what the removed modules did and where their behavior lives now.
